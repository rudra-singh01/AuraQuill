    ...
    try {
      const result = await emailjs.send(
        ...
        "template_zh1wohp",
        {
          ...
          to_email: 'auraquilldigital@gmail.com',
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          >
            ...
            through expert digital marketing and copywriting services.
          </motion.p>
        </motion.div>
        {isMobile && (
          <motion.div
          ...
          >
            <button
              ...
              className={`flex items-center text-sm px-4 py-2 rounded ${
                contactMethod === 'form'
                  ? 'bg-[#c5f82a] text-[#0a1f1c]'
                  : 'bg-transparent text-white border border-[#c5f82a]'
              }`}
            >
              <svg
